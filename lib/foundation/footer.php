...
add_action( 'genesis_before_footer', 'ygf_footer_widget_areas' );
/**
 ...
 */
function ygf_footer_widget_areas() {
	...
	while ( $counter <= $footer_widgets ) {
		...
		$inside .= sprintf( '<div class="columns small-12 medium-6 large-%d footer-widgets-%d widget-area">%s</div>', $footer_widget_large_class,  $counter, $widgets );
