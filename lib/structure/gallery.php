...
add_filter("post_gallery", "ygf_gallery_clearing",10,2);
function ygf_gallery_clearing($output, $attr) {
    global $post;
    ...
    $gallery_div = "<ul id='$selector' class='clearing-thumbs small-block-grid-{$columns} gallery galleryid-{$id} gallery-columns-{$columns} gallery-size-{$size_class}' data-clearing>";
